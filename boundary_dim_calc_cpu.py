...
def mandelbrot_boundary_cpu(res_c, res, res_tile, iter_scale, growth_rate):
    ########parameters##########
            ...
            while tile_stop_c <= tile_stop:
                ...
                while tile_c_y < tile_stop_c:
                    while tile_c_x < tile_stop_c:
                        ...
                        #update user
                        print("Now finding the set")
                        #these nested loops loop over the logic set (which is now on the npu) to find the amount of points in the boundary of the set
